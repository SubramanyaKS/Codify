...
function Loader({ asOverlay = true }) {
  ...
  return (
    <div
      className={`${
        asOverlay ? "inset-0 fixed" : "py-24"
      } flex flex-col items-center justify-center z-[9999] ${
        isDark ? "bg-black/90" : "bg-light-bg-primary/80"
      } backdrop-blur-sm`}
    >
      ...
      <div className="flex items-center justify-center font-righteous text-4xl mb-4">
        <span
          className={`inline-block animate-bounce-slow animation-delay-100 ${
        ...
        <span
          className={`inline-block animate-bounce-slow animation-delay-200 ${
            isDark ? "text-white" : "text-primary"
          } transform hover:scale-110 transition-transform`}
        >
          o
        ...
        <span
          className={`inline-block animate-bounce-slow animation-delay-300 ${
            isDark ? "text-white" : "text-primary"
          } transform hover:scale-110 transition-transform`}
        >
          d
        ...
        <span
          className={`inline-block animate-bounce-slow animation-delay-400 ${
            isDark ? "text-white" : "text-primary"
          } transform hover:scale-110 transition-transform`}
        >
          i
        ...
        <span
          className={`inline-block animate-bounce-slow animation-delay-500 ${
            isDark ? "text-white" : "text-primary"
          } transform hover:scale-110 transition-transform`}
        >
          f
        ...
        <span
          className={`inline-block animate-bounce-slow animation-delay-600 ${
            isDark ? "text-white" : "text-primary"
          } transform hover:scale-110 transition-transform`}
        >
          y
      ...
      <div className="absolute top-1/4 left-1/4 transform -translate-x-1/2 -translate-y-1/2">
        <div
          className={`w-6 h-6 ${
            isDark ? "text-primary" : "text-primary/30"
          } animate-spin-slow`}
        >
      ...
      <div className="absolute top-3/4 right-1/4 transform translate-x-1/2 translate-y-1/2">
        <div
          className={`w-5 h-5 ${
            isDark ? "text-primary" : "text-primary/40"
          } animate-bounce animation-delay-800`}
        >
          <svg fill="currentColor" viewBox="0 0 24 24">
      ...
      <div className="absolute bottom-1/4 left-1/3 transform -translate-x-1/2 translate-y-1/2">
        <div
          className={`w-4 h-4 ${
            isDark ? "text-primary" : "text-primary/25"
