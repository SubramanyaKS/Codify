        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredNotes.length > 0 ? (
            ...
            >
              ...
              >
                No notes match your search for "{searchQuery}". Try different
                keywords.
              </p>
              <button
                onClick={clearSearch}
...
const NotesCard = forwardRef(
  ({ isDark, name, content, link, icon, searchQuery }, ref) => {
    ...
    return (
      <div
        ref={ref}
        className={`group relative p-4 sm:p-6 lg:p-8 rounded-2xl shadow-lg flex flex-col justify-between min-h-[200px] hover:border-b-2 hover:border-r-2 bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-gray-800 dark:to-secondary-1000 backdrop-blur-xl ${
          isDark
